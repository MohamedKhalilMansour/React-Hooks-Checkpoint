...
trailer: 'https://www.youtube.com/watch?v=s7EdQ4FqbhY&ab_channel=Movieclips'},
  {id: '2' ,
    ...
    rating: '7',
    trailer: 'https://www.youtube.com/watch?v=KnrRy6kSFF0&ab_channel=RottenTomatoesClassicTrailers'
  },
  {id: '3' ,
    ...
    rating: '9',
    trailer: 'https://www.youtube.com/watch?v=OiqLaKXONQs&ab_channel=FreddyKrueger'
  }
]
 ...
 const rateMov = (number) => {
  ...
  return (
    ...
    <div className="App">
      ...
      <Routes>
        <Route path='/' element={ <MovieList list={list.filter(el => el.title.toLowerCase().includes(keyWords.toLowerCase().trim()) && el.rating >= rating)} />}></Route>
        <Route path='/movie/:id' element={<Description el={list} />}></Route>
      </Routes>
    </div>
